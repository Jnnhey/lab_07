...
# This distribution shows that the graph is not symmetrical. The most probable score is clearly around 4.5, which is rather high. It is not what I have imagined, as the bty_avg is a lot lower than the score avg, which shows that even tho most people have a low bty_avg it seems to have limited correlation with the score given.
